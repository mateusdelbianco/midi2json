...
var ReadAlong = {
    ...
    generateWordList: function () {
        ...
        var word_els2 = this.text_element.querySelectorAll('[data-begintwo]');
        this.words = Array.prototype.map.call(word_els, function (word_el, index) {
            ...
            return word;
        }).concat(Array.prototype.map.call(word_els2, function (word_el, index) {
            var word = {
                'begin': parseFloat(word_el.dataset.begintwo),
                'dur': parseFloat(word_el.dataset.dur),
                'element': word_el
            };
            word_el.tabIndex = 0; // to make it focusable/interactive
